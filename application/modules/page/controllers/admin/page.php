...
class Page extends Admin_Controller {
    ...
    */
    public function edit_page($id){
    	if($id){
    		$id = (int) $id;
    		$this->db->select('pages.id as id, date_published, pages.date_created as date_created, title, pages.image as image, pages.image_thumb as image_thumb, content, pages.status as status, username, first_name, last_name');
