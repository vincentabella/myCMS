<div class="content-wrapper">
    <h3 class="page-heading mb-4">Add New Page </h3>
               ...
               <div class="card-body my-card">
                    <div class="col-md-12 no-padding">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control p-input" value="" name="title" id="title" placeholder="Enter page title">
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body my-card card-spacer">
                    <div class="col-md-12 no-padding">
                        <div class="form-group">
                            ...
                            <textarea class="form-control p-input" name="content" id="content" rows="5" placeholder="Please type the page content"></textarea>
                        </div>
                    </div>
                </div>
            </div>
	...
	$(document).ready(function(){
        ...
        */
        function savePage(){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'page/admin/page/save_page',
                dataType: 'json',
                data: {
                    title: title, 
                    content: content, 
        ...
        */
       	function showSuccessMessage(page_id) {
            swal({
                title: "Good Job!",
                text: "New page has been added!",
                type: "success",
                ...
                closeOnConfirm: false
                    ...
                    window.location.replace( base_url+"admin/pages/edit/" +page_id);
            });
        }
