            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-sm-3 col-sm-offset-3 pull-right">
                        <form id="form-search" action="<?php echo site_url('page/admin/page/search');?>" method="post">  
                    ...
                    <!-- Search Form -->
                  	...
                  	<h5 class="card-title mb-4">All Pages &nbsp;&nbsp;<a href="<?php echo site_url('admin/pages/add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> &nbsp;Add New Page</a></h5>
    ...
    $(document).ready(function(){
        ...
        */
        function deletePage(page_id){
            $.ajax({
                type: "POST",
                url: base_url +'page/admin/page/move_to_trash',
                dataType: 'json',
                data: {
                    page_id: page_id,
                    form_submit: true,
        ...
        */
        function deletePagePermanently(page_id){
            $.ajax({
                type: "POST",
                url: base_url +'page/admin/page/delete_page',
                dataType: 'json',
                data: {
                    page_id: page_id,
                    form_submit: true,
