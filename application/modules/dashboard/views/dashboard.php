                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right">
                                ...
                                <h4 class="bold-text">9</h4>
                            </div>
                        </div>
                        <p class="text-muted">
                            <i class="fa fa-check-square-o mr-1" aria-hidden="true"></i> Active site users
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <?php if($recent_posts): ?>
                            <?php foreach($recent_posts as $item):?>
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <a href="<?php echo site_url('admin/blogs/edit/'.$item->id);?>" class="post-title"><?php echo $item->title;?></a>
                                    </div>
                                </div>
                                <br>   
                            <?php endforeach;?>
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><a href="<?php echo site_url('admin/pages/add');?>">Add New Page</a></p>
