    ...
    $(document).ready(function(){
        ...
        */
        function saveUser(){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'user/admin/user/save',
                dataType: 'json',
                data: {
                    username: username, 
                    email: email, 
        ...
        */
        ...
        function checkUsernameExist(username){
            $.ajax({
                type: "POST",
                url: base_url +'user/admin/user/is_username_exist',
                dataType: 'json',
                data: {
                    username: username, 
                }, 
                ...
                success: function(response){
                   if(response.exist == true){
                        $('#check-username').html('<span style="color: red;"><i class="fa fa-check" aria-hidden="true"></i> Username not available</span>');
                        username_exist = true;
                   }else{
