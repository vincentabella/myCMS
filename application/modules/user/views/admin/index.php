            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col-sm-3 col-sm-offset-3 pull-right">
                        <form id="form-search" action="<?php echo site_url('user/admin/user/search');?>" method="post">  
                    ...
                    <h5 class="card-title mb-4">All Users &nbsp;&nbsp;<a href="<?php echo site_url('admin/users/add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> &nbsp;Add New User</a></h5>
                    	...
                    	<table class="table center-aligned-table">
                      	...
                      	<tbody>
                        	<?php if($users): foreach($users as $user):?>
                        		<tr class="">
                        			<td><img src="<?php echo $user->image;?>" alt="profile image" style="width: 50px;height:50px;border-radius: 50%;float: left;margin-right: 10px;"></td>
    ...
    $(document).ready(function(){
        ...
        */
        function deleteUser(user_id){
             $.ajax({
                type: "POST",
                url: base_url +'user/admin/user/delete',
                dataType: 'json',
                data: {
                    user_id: user_id,
                }, 
