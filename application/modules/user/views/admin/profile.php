        ...
        <div class="col-md-4 col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="imageform" class="pull-right" method="post" enctype="multipart/form-data" action='<?php echo site_url('blog/admin/blog/upload_image');?>'>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#photoimg').on('change', function(){ 
            ...
            $("#imageform").ajaxForm({
                ...
                success: function(response) {
                    ...
                    $(".user-img").html('<img src="'+response.image_url +'" class="img-responsive">');
        ...
        function save_avatar(image){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'user/admin/user/update_avatar',
                dataType: 'json',
                data: {
                    image: image, 
                    form_submit: true
        ...
        */
        ...
        function update_user_info(email, first_name, last_name){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'user/admin/user/update_user_info',
                dataType: 'json',
                data: {
                    email: email, 
        ...
        */
        ...
        function change_password(old_password, new_password){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'user/admin/user/change_password',
                dataType: 'json',
                data: {
