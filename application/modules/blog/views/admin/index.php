            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Search Form -->
                  	...
                  	<h5 class="card-title mb-4">All Posts &nbsp;&nbsp;<a href="<?php echo site_url('admin/blogs/add');?>" class="btn btn-primary"><i class="fa fa-plus"></i> &nbsp;Add New Post</a></h5>
    ...
    $(document).ready(function(){
        ...
        */
        function deletePost(post_id){
            $.ajax({
                type: "POST",
                url: base_url +'blog/admin/blog/move_to_trash',
                dataType: 'json',
                data: {
                    post_id: post_id,
                    form_submit: true,
        ...
        */
        function deletePostPermanently(post_id){
            $.ajax({
                type: "POST",
                url: base_url +'blog/admin/blog/delete_post',
                dataType: 'json',
                data: {
                    post_id: post_id,
                    form_submit: true,
        ...
        */
        ...
        function showDeletePermanentlySuccess() {
            swal({
                ...
                location.href = base_url +'admin/blogs'; //reload page after submitted
            });
        }
