    ...
    $(document).ready(function(){
        ...
        */
        ...
        function save_menu_item_from_post(menu_type_id, posts_selected){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'menus/admin/menus/save_menu_item_from_post',
                data: {
                    menu_type_id: menu_type_id,
        ...
        */
        ...
        function save_menu_item_from_category(menu_type_id, category_selected){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'menus/admin/menus/save_menu_item_from_post_category',
                data: {
                    menu_type_id: menu_type_id,
        ...
        */
        ...
        function save_menu_item_from_page(menu_type_id, page_selected){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'menus/admin/menus/save_menu_item_from_page',
                data: {
                    menu_type_id: menu_type_id,
        ...
        */
        ...
        function save_menu_item_from_module(menu_type_id, module_selected){
            ...
            $.ajax({
                type: "POST",
                url: base_url +'menus/admin/menus/save_menu_item_from_module',
                data: {
                    menu_type_id: menu_type_id,
